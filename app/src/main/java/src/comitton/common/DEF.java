...
public class DEF {
	...
	static public String getFontDirectory() {
		return Environment.getExternalStorageDirectory() + "/comittont/font/";
	}

	static public String getConfigDirectory() {
		return Environment.getExternalStorageDirectory() + "/comittont/conf/";
	}
	...
	static public String getBaseDirectory() {
		return Environment.getExternalStorageDirectory() + "/comittont/";
	}
