...
//		y +=  MARGIN_CY;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mTitleSep = getMultiLine(mTitle + mSmbVer, cx, mTextPaint);
...
//		invalidate();
	...
	// パスの設定
	public void setFileInfo(long thumbId, int bmIndex, boolean bmView, String title, String summary, boolean showext, String smb) {
		// サムネイルなし
		mThumbId = thumbId;
		mThumbIndex = bmIndex;
		mThumbView = bmView;
